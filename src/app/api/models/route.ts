...
const KIE_MODELS: ProviderModel[] = [
  ...
  // ============ Sora 2 Models (6) ============
  {
    ...
    name: "Sora 2",
    description: "OpenAI Sora 2 text-to-video generation with synchronized audio. Up to 10s video.",
    provider: "kie",
    capabilities: ["text-to-video"],
    coverImage: undefined,
  ...
  },
  {
    ...
    name: "Sora 2 I2V",
    description: "OpenAI Sora 2 image-to-video generation. Use an image as the first frame.",
    provider: "kie",
    capabilities: ["image-to-video"],
    coverImage: undefined,
    pricing: { type: "per-run", amount: 0.15, currency: "USD" },
  ...
  },
  {
    ...
    name: "Sora 2 Pro",
    description: "Sora 2 Pro text-to-video — higher fidelity, up to 15s in 1080p HD with native audio.",
    provider: "kie",
    capabilities: ["text-to-video"],
    coverImage: undefined,
  ...
  },
  {
    ...
    name: "Sora 2 Pro I2V",
    description: "Sora 2 Pro image-to-video — higher fidelity generation from a reference image.",
    provider: "kie",
    capabilities: ["image-to-video"],
    coverImage: undefined,
    pricing: { type: "per-run", amount: 0.30, currency: "USD" },
  ...
  },
  {
    ...
    description: "Animate a character from a short video clip. Upload a 1-4s character video to generate animations.",
    provider: "kie",
    capabilities: ["image-to-video"],
    coverImage: undefined,
    pageUrl: "https://kie.ai/sora-2",
  },
  {
    ...
    description: "Remove watermarks from generated videos using Sora AI.",
    provider: "kie",
    capabilities: ["image-to-video"],
    coverImage: undefined,
    pageUrl: "https://kie.ai/sora-2",

...
const FAL_CURATED_MODELS: ProviderModel[] = [
  ...
  // --- Seedance 2.0 ---
  {
    ...
    description: "ByteDance Seedance 2.0 cinematic video with native audio, multi-shot editing, real-world physics, and director-level camera control.",
    provider: "fal",
    capabilities: ["text-to-video"],
    coverImage: undefined,
  ...
  },
  {
    ...
    description: "Animate still images into cinematic video with synchronized audio, start/end frame control, and motion prompts.",
    provider: "fal",
    capabilities: ["image-to-video"],
    coverImage: undefined,
    pageUrl: "https://fal.ai/models/bytedance/seedance-2.0/image-to-video",
  },
  {
    id: "bytedance/seedance-2.0/reference-to-video",
    name: "Seedance 2.0 Reference-to-Video",
    description: "Generate video from up to 9 images, 3 videos, and 3 audio clips with native audio and cinematic camera control.",
    provider: "fal",
    capabilities: ["image-to-video"],
    coverImage: undefined,
    pageUrl: "https://fal.ai/models/bytedance/seedance-2.0/reference-to-video",
  },
  {
    id: "bytedance/seedance-2.0/fast/text-to-video",
    name: "Seedance 2.0 Fast Text-to-Video",
    description: "Lower latency and cost variant of Seedance 2.0 with cinematic output, native audio, and director-level camera control.",
    provider: "fal",
    capabilities: ["text-to-video"],
    coverImage: undefined,
  ...
  },
  {
    ...
    description: "Lower latency and cost variant with synchronized audio, start/end frame control, and motion prompts.",
    provider: "fal",
    capabilities: ["image-to-video"],
    coverImage: undefined,
    pageUrl: "https://fal.ai/models/bytedance/seedance-2.0/fast/image-to-video",
  },
  {
    id: "bytedance/seedance-2.0/fast/reference-to-video",
    name: "Seedance 2.0 Fast Reference-to-Video",
    description: "Lower latency and cost variant supporting up to 9 images, 3 videos, and 3 audio clips as inputs.",
    provider: "fal",
    capabilities: ["image-to-video"],
    coverImage: undefined,
    pageUrl: "https://fal.ai/models/bytedance/seedance-2.0/fast/reference-to-video",
  },
  // --- Older / Other ---
  {
